...
export const metadata = { title: "Suscripción — Clinicomatic" };
  ...
  return (
    <div className="mx-auto max-w-5xl px-5 py-8 space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--text-soft)]">Gestiona el plan de tu clínica y la facturación de Clinicomatic.</p>
      </div>
